...
rigibody2 = (((( - x10 + ( - x11 + ( - x12 + ( - x13 + ( - x14 + ( - x15)))))) * x3) * x2 + (( (2/1) * x4 + ( (2/1) * x5 + ( (2/1) * x6 + ( (2/1) * x9 + ( (2/1) * x13 + ( (2/1) * x14 + ( (2/1) * x15))))))) * x3)) * x2) * x1 + (( - x15) * x2 + (( (6/1) * x7 + ( (6/1) * x8 + ( (3/1) * x9 + ( (3/1) * x13 + ( (6/1) * x14 + ( (6/1) * x15)))))) * x3^2));
...
[p_geneig, p_mvbeta, p_robustsdp] = comparaison(iter, rigibody2, var, a, b, err);
[m_geneig, m_mvbeta, m_robustsdp] = comparaison(iter, -rigibody2, var, a, b, err);
