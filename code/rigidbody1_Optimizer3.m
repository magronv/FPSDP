...
rigidbody1 = (( - x4 + ( - x5 + ( - x7 + ( - x8 + ( - x11 + ( - x12 + ( - x13))))))) * x2 + ( - x4 + ( - x12 + ( - x13)))) * x1 + ((( (-2/1) * x5 + ( (-2/1) * x6 + ( (-2/1) * x9 + ( (-2/1) * x10 + ( (-2/1) * x11 + ( (-2/1) * x12 + ( (-2/1) * x13))))))) * x3) * x2 + (( - x6 + ( - x13)) * x3));
...
calculate_robustsdp(8, rigidbody1, var, a, b, err);
